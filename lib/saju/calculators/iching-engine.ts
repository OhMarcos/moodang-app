...
// Trigram order: 건(0) 태(1) 이(2) 진(3) 손(4) 감(5) 간(6) 곤(7)
const HEXAGRAM_MATRIX = [
  [ 1, 10, 13, 25, 44,  6, 33, 12],  // upper: 건
  [43, 58, 49, 17, 28, 47, 31, 45],  // upper: 태
  [14, 38, 30, 21, 50, 64, 56, 35],  // upper: 이
  [34, 54, 55, 51, 32, 40, 62, 16],  // upper: 진
  [ 9, 61, 37, 42, 57, 59, 53, 20],  // upper: 손
  [ 5, 60, 63,  3, 48, 29, 39,  8],  // upper: 감
  [26, 41, 22, 27, 18,  4, 52, 23],  // upper: 간
  [11, 19, 36, 24, 46,  7, 15,  2],  // upper: 곤
];
